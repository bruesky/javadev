...
class Domain
{
	...
	private void createDomainObjects()
	{
		...
		Vendor[] v =
		{
			new Vendor("Gateway Outlet", "1245 Parkway Dr.", "(320) 567 9987", "(320) 977 0889"),
		...
		Terms[] t =
		{
			new Terms(v[0], p[0], 6500.00, "Overnight", "30 days"),
	...
	public Vector getProducts()  {return Product.getManager().getAll();}
	public Vector getVendors() 	 {return Vendor.getManager().getAll();}
	public Vector getTerms() 	 {return Terms.getManager().getAll();}
}