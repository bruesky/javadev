...
public class Scenario extends MissionItem
{
	...
	public List<Action> plannedActions() { return Associations.scenarioIsComposedOfPlannedActions.leftToRights(this); }
	 ...
	 public void isConsideredFor(Mission mission){
		Associations.scenarioAreConsideredForMissions.link(this,mission);
	 }
	 public void isNotConsideredForMission(Mission mission){
		 Associations.scenarioAreConsideredForMissions.unlink(this,mission);
	 }

	
	public void isRetainedFor(Mission mission) {Associations.scenarioIsRetainedForAMission.link(this, mission);}
	public void isNotRetainedFor(Mission mission) {Associations.scenarioIsRetainedForAMission.unlink(this, mission);}
	
	 public void addConfirmedAction(Action action){
		Associations.scenarioConfirmedAction.link(this,action);
	 }
	 public List<Action> confirmedActions(){
		 return Associations.scenarioConfirmedAction.leftToRights(this);
	 }
	...
	public String getExtendedReport(String indentation)
	{
		...
		List<Action> actions= confirmedActions();

		for (Action action: actions) {
			extRep.append(action.getReport(nextLevelOfIndentation));
		}
