...
public class Domain
{
	public void buildDynamicObjects()
	{
		...
		singleScenarios[quick].isConsideredFor(theMojaveSurvey);
		singleScenarios[deep].isConsideredFor(theMojaveSurvey);
		singleScenarios[survey].isConsideredFor(theMojaveSurvey);


		singleScenarios[special].isRetainedFor(theMojaveSurvey);						// This Scenario is retained for the first Mission
		
		// TODO: theMojaveSurvey
		// This Scenario is no longer considered for the first Mission
		singleScenarios[special].isConsideredFor(theMojaveSurvey);
		// Build Actions
		...
		retainedForMojave.addConfirmedAction(actionItems[takeoff]);
		...
		retainedForMojave.addConfirmedAction(actualReachingOfMojave);
		...
		retainedForMojave.addConfirmedAction(actionItems[inspect]);
		retainedForMojave.addConfirmedAction(actionItems[flyback]);
		// Build Crews
		Crew[] crews =
		{
		new Crew("Alpha"),
